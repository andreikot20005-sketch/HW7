...
public class Main {
 ...
 toadEyesCount = new Scanner(System.in).nextInt();
        ...
        System.out.println(" Введите кол-во cлез вурдалака");
        ghoulTearsCount = new Scanner(System.in).nextInt();

        System.out.println(" Введите кол-во костей вороны");
       ...
       dumplingsCount = new Scanner(System.in).nextInt();
        ...
        if ( ghoulTearsCount >= 7 &&  dumplingsCount  >= 10 && ravenBonesCount >=3 ) {
            System.out.println(" Вы можете изготовить Запретный элексир");
            isCanCook = true;
        }
        if (!isCanCook){
            System.out.println("Вы не можеите приготовить не один элексир ");
